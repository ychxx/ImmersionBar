...
// 初始化ImmersionBar
inline fun AppCompatActivity.immersionBar(block: ImmersionBar.() -> Unit) = ImmersionBar.with(this).apply { block(this) }.init()
...
inline fun Dialog.immersionBar(activity: AppCompatActivity, block: ImmersionBar.() -> Unit) = ImmersionBar.with(activity, this).apply { block(this) }.init()

inline fun AppCompatActivity.immersionBar(dialog: Dialog, block: ImmersionBar.() -> Unit) = ImmersionBar.with(this, dialog).apply { block(this) }.init()
...
fun AppCompatActivity.fitsTitleBarMarginTop(vararg view: View) = ImmersionBar.setTitleBarMarginTop(this, *view)
...
// 隐藏状态栏
fun AppCompatActivity.hideStatusBar() = ImmersionBar.hideStatusBar(window)
...
// 显示状态栏
fun AppCompatActivity.showStatusBar() = ImmersionBar.showStatusBar(window)
